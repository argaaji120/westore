...
<head>
  ...
  <title>Westore - @yield('title', 'My Dashboard')</title>
      ...
      <div class="border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
          ...
          <a href="{{ route('transactions.index') }}"
            class="list-group-item list-group-item-action{{ request()->is('transactions*') ? ' active' : '' }}">
            Transactions
          </a>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav d-none d-lg-flex ml-auto">
                <li class="nav-item">
                  <a class="nav-link d-inline-block mt-2" href="{{ route('cart') }}">
                    <img src="{{ asset('assets/images/icons/icon-cart.svg') }}" alt="" />
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link" href="" id="navbarDropdown" role="button" data-toggle="dropdown">
                    <img src="{{ url('assets/images/avatar.png') }}" alt=""
                      class="rounder-circle mr-2 profile-picture" />
                    Hi, Arga Aji
                  </a>
              ...
              <ul class="navbar-nav d-block d-lg-none">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link" href="" id="navbarDropdownM" role="button" data-toggle="dropdown"> Hi, Arga Aji
                  </a>
