            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12 col-md-4">
                  <img src="{{ url('assets/images/products/product-2.jpg') }}" alt="" class="w-100 mb-3" />
                </div>
                <div class="col-12 col-md-8">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle text-danger">@{{ status }}</div>
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="col-12 mt-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="row">
                        ...
                        <template v-if="status == 'SHIPPING'">
                          <div class="col-md-3">
                            ...
                            <input class="form-control" type="text" name="resi" v-model="resi" />
                          </div>
                          <div class="col-md-2">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <button type="button" class="btn btn-success btn-block mt-4">Save Now</button>
                        </div>
                      </div>
                    </div>
                  </div>
