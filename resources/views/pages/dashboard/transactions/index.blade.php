        ...
        <div class="tab-pane fade show active" id="sell" role="tabpanel" aria-labelledby="sell-tab">
          <div class="row mt-3">
            <div class="col 12 mt-2">
              <a class="card card-list d-block" href="{{ route('transactions.show', 1) }}">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-1">
                      <img src="{{ url('assets/images/dashboard-icon-product-1.png') }}" alt="" />
                    </div>
                    <div class="col-md-4">Shirup Marzzan</div>
                    <div class="col-md-3">Angga Risky</div>
                    <div class="col-md-3">12 Januari, 2020</div>
                    <div class="col-md-1 d-none d-md-block">
                      <img src="{{ asset('assets/images/dashboard-arrow-right.svg') }}" alt="" />
                    </div>
                  </div>
                </div>
              </a>
              <a class="card card-list d-block" href="{{ route('transactions.show', 1) }}">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-1">
                      <img src="{{ url('assets/images/dashboard-icon-product-2.png') }}" alt="" />
                    </div>
              ...
              <a class="card card-list d-block" href="{{ route('transactions.show', 1) }}">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-1">
                      <img src="{{ url('assets/images/dashboard-icon-product-3.png') }}" alt="" />
                    </div>
